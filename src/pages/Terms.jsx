        ...
        <div className="legal-page">
            <div className="container max-w-4xl mx-auto">
                ...
                <div className="legal-two-col gap-12 md:gap-16">
                    <section>
                        <h2 className="legal-section-title">2. Engagement & Conduct</h2>
                        <p className="legal-section-body">
                    ...
                    <section>
                        <h2 className="legal-section-title">4. Contact Us</h2>
                        <p className="legal-section-body">
                    ...
                    <section>
                        <h2 className="legal-section-title">3. Liability & Governing Law</h2>
                        <p className="legal-section-body">
